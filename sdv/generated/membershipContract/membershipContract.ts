...
export class membershipContract extends ethereum.SmartContract {
  static bind(address: Address): membershipContract {
    return new membershipContract("membershipContract", address);
  }
