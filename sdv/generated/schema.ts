...
export class TransferSingle extends Entity {
  ...
  get membershipContract_id(): BigInt {
    let value = this.get("membershipContract_id");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set membershipContract_id(value: BigInt) {
    this.set("membershipContract_id", Value.fromBigInt(value));
  }
